...
for (let i = 0; i < number.length; i++) {
  number[i].addEventListener("click",operatorfn);
}
...
for (let i = 0; i < operator.length; i++) {
  operator[i].addEventListener("click",currentstringfn);
}
function currentstringfn(e) {
...
result.addEventListener("click", resultfn)
